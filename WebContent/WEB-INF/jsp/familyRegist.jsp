			...
			<table>
				...
				<tr>
					<td><label>アイコン画像<br> <input type="file"
							accept="image/*" name="icon" id="icon">
					</label>
						<p id="error_icon" style="display: none">画像サイズが大きすぎます</p></td>
				...
				<tr>
					<td><label>家族パスワード<br> <input type="password"
							name="family_pass" id="f_pass" maxlength="20"> <span
							class="pass_warn">8文字以上20文字以内の大文字を1文字以上含む半角英数字を入力してください<br></span>
					</label></td>
				<tr>
				<tr>
				...
				<tr>
					<td><label>代表者個人パスワード<br> <input type="password"
							name="user_pass" id="u_pass" maxlength="20"> <span
							class="pass_warn">8文字以上20文字以内の大文字を1文字以上含む半角英数字を入力してください<br></span>
					</label></td>
				<tr>
				<tr>
